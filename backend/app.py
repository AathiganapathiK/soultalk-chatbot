...
def generate_session_title(text):
    ...
    using Cohere chat model, without fancy or overly formal words.
    """
    prompt = f"""
You are an assistant that generates a *short, simple, meaningful title* (3-4 words)
for the following user message. The title should *use plain, everyday English*,
summarize the main idea or feeling, and *avoid fancy words or phrases*.
